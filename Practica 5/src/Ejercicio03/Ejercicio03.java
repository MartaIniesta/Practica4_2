...
public class Ejercicio03 {
	public static void main(String[] args) {
		...
		String palabra = "en";
		System.out.println(texto + "\n\nLa palabra \"en\" coincide -> " + obtenerNumeroVecesSubCadena(texto, palabra) + " veces");
		
		System.out.println("\nFin del programa");	
	}
	
	public static int obtenerNumeroVecesSubCadena(String texto, String palabra) {
		return texto.split(palabra).length-1;
		/*int contador = 0;
		for(int i = 0; i < texto.length(); i++) {
			if(texto.indexOf(palabra, i) == i) {
				contador++;
			}
		}
		return contador;*/
